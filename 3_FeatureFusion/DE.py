...
def load_data():
    data1 = pd.read_csv('E:/Clatherin_Research/featureFusionRelated/ESM-Features-Clathrin-train.csv',header=None)
    data2 = pd.read_csv('E:/Clatherin_Research/featureFusionRelated/PSSM_CLBP_Clath_Training.csv',header=None)
    data3 = pd.read_csv('E:/Clatherin_Research/featureFusionRelated/QLC_feat_Clathrin_Training.csv',header=None)
    data4 = pd.read_csv('E:/Clatherin_Research/featureFusionRelated/RECM_CLBP_Clath_Training.csv',header=None)
    labels = data1.iloc[:,1280:].values
    labels = labels.ravel()
    features1 = data1.iloc[:,0:1280].values
    features2 = data2.iloc[:,0:236].values
    features3 = data3.iloc[:,0:147].values
    features4 = data4.iloc[:,0:236].values
...
feature_names = ["ESM", "PSSM_CLBP", "QLC", "RECM_CLBP"]
